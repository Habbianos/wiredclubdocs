...
| Tabelas de Classificação | Placar de Usuários. Registram os ganhadores de jogos como Battle Banzai e Freeze, além das diversas utilizações criadas através de sistemas Wired. |
